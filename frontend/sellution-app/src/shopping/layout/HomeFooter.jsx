...
const HomeFooter = () => {
  return (
    <nav className='fixed bottom-0 left-1/2 transform -translate-x-1/2 z-10 w-full max-w-lg h-16 bg-white flex shadow-footer p-1.5'>
      <Link to='/' className='flex-1 bg-white flex flex-col justify-center items-center'>
      ...
      <Link to='/' className='flex-1 bg-white flex flex-col justify-center items-center relative'>
