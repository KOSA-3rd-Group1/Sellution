...
public class CategoryController {
    ...
    @GetMapping
    public ResponseEntity<Page<FindCategoryRes>> getAllCategories(@RequestParam Long companyId, @RequestParam(required = false) DisplayStatus isVisible, Pageable pageable) {
        return ResponseEntity.ok(categoryService.getAllCategories(companyId,isVisible,pageable));
    }
