...
-- Order 데이터
INSERT INTO orders (account_id,company_id, customer_id, address_id, month_option_id, week_option_id, code, type, status, delivery_status, per_price,total_price, next_delivery_date,delivery_start_date, delivery_end_date, total_delivery_count, remaining_delivery_count, created_at, updated_at)
VALUES
    (1,1, 1, 1, 1, 1, 20240101000001, 'MONTH_SUBSCRIPTION', 'APPROVED', 'BEFORE_DELIVERY', 60000,600000,'2024-02-15', '2024-01-15', '2024-02-15', 4, 4, NOW(), NOW()),
(1,1, 2, 2, NULL, 2, 20240101000002, 'COUNT_SUBSCRIPTION', 'APPROVED', 'IN_PROGRESS', 100000,600000,'2024-02-15', '2024-01-10', '2024-03-10', 8, 7, NOW(), NOW()),
(1,2, 3, 3, NULL, NULL, 20240101000003, 'ONETIME', 'APPROVED', 'COMPLETE', 16000,600000,'2024-02-15', '2024-01-05', '2024-01-05', 1, 0, NOW(), NOW()),
(1,3, 4, 4, 2, 3, 20240101000004, 'MONTH_SUBSCRIPTION', 'APPROVED', 'BEFORE_DELIVERY', 120000,600000,'2024-02-15', '2024-02-01', '2024-04-01', 8, 8, NOW(), NOW()),
(1,1, 5, 5, NULL, 1, 20240101000005, 'COUNT_SUBSCRIPTION', 'HOLD', 'BEFORE_DELIVERY', 75000,600000,'2024-02-15', '2024-01-20', '2024-03-20', 6, 6, NOW(), NOW()),
(1,2, 6, 6, NULL, NULL, 20240101000006, 'ONETIME', 'CANCEL', 'BEFORE_DELIVERY', 14000,600000,'2024-02-15', '2024-01-18', '2024-01-18', 1, 1, NOW(), NOW()),
(1,3, 7, 7, 3, 2, 20240101000007, 'MONTH_SUBSCRIPTION', 'APPROVED', 'IN_PROGRESS', 180000,600000,'2024-02-15', '2024-01-05', '2024-07-05', 24, 22, NOW(), NOW()),
(1,1, 1, 8, NULL, 3, 20240101000008, 'COUNT_SUBSCRIPTION', 'APPROVED', 'BEFORE_DELIVERY', 50000,600000,'2024-02-15', '2024-02-01', '2024-04-01', 10, 10, NOW(), NOW()),
(1,2, 3, 3, NULL, NULL, 20240101000009, 'ONETIME', 'APPROVED', 'IN_PROGRESS', 24000,600000,'2024-02-15', '2024-01-22', '2024-01-22', 1, 0, NOW(), NOW()),
(1,3, 4, 9, 1, 1, 20240101000010, 'MONTH_SUBSCRIPTION', 'HOLD', 'BEFORE_DELIVERY', 90000,600000,'2024-02-15', '2024-02-05', '2024-03-05', 4, 4, NOW(), NOW());
